= Rails 4.1 PyGoogle ({http://pygoogle.com}[http://pygoogle.com])

(Note) This repo is for pygoogle.com. 

Demo version is available at demo.pygoogle.com


Bootstrap 3 / Foundation 5 + CoffeeScript + Sass + Devise + everything else you need to get into production, fast.

This repo was cloned from {Rails 4 Starter-kit}[https://github.com/starterkits/rails4-starterkit] and tested with Apache + Phusion passenger (see the screen shots in Demo section).
Tutorial : {Deploying a Rails 4 app on CentOS 7 production server with Apache and Passenger}[http://bogotobogo.com/RubyOnRails/RubyOnRails-Deploying-a-Rails4-App-on-CentOS7-production-server-with-Apache-and-Passenger.php]

= Overview

Rails 4.1 PyGoogle is a starter app with production ready performance, security, and authentication.
...
Unlike most starter apps that focus on kick starting development, Rails 4.1 PyGoogle is opinionated and production ready.
It combines the best gems, best practices, and optimized configuration to minimize common mistakes and repetitious
framework setup.

Beyond configuration and tests, the bulk of Rails 4.1 PyGoogle code is the authentication flows.
...
{Demo available at http://demo.pygoogle.com}[http://demo.pygoogle.com] — Bootstrap 3

{Email Template Preview - not for production}[http://demo.pygoogle.com/p/email?premail=true&layout=email] — with inline CSS via Premailer

----
Demo Images 

{Landing Page}[http://demo.pygoogle.com/PyGoogleImages/PyGoogleLandingPage.png]

{SignUp Page}[http://demo.pygoogle.com/PyGoogleImages/PyGoogleSignUpPage.png]

{Facebook Sign Up Page}[http://demo.pygoogle.com/PyGoogleImages/PyGoogleFacebookSignUp.png]

{After signin Facebook}[http://demo.pygoogle.com/PyGoogleImages/PyGoogleSignUpAfterFacebookLogin.png] 

{User Home after signin via Facebook}[http://demo.pygoogle.com/PyGoogleImages/PyGoogleUserHomeAfterSigningUpViaFacebook.png]

{Twitter Sign Up Page}[http://demo.pygoogle.com/PyGoogleImages/PyGoogleTwitterSignUp.png]

{After signin Twitter}[http://demo.pygoogle.com/PyGoogleImages/PyGoogleSignUpAfterTwitterLogin.png]

{Native site Sign Up Page}[http://demo.pygoogle.com/PyGoogleImages/PyGoogleDirectSignUpPage.png]
...
* Bootstrap3[http://getbootstrap.com/] enabled — master[https://github.com/PyGoogle/Rails4-PyGoogle.git/tree/master] branch
* Foundation5[http://foundation.zurb.com/] enabled — foundation[https://github.com/PyGoogle/Rails4-PyGoogle.git/tree/foundation] branch 
...
Gemfile is configured for OSX development. See comments in Gemfile for Linux.
  ...
  git clone https://github.com/PyGoogle/Rails4-PyGoogle.git
  cd Rails4-PyGoogle.git
...
Modify config/locales/en.yml. Replace references PyGoogle to yours.

Modify config/application.rb. Replace references PyGoogle to yours.
...
Ruby 2.0+ uses byebug instead of debugger. PyGoogle is configured to use pry or byebug.
...
PyGoogle is setup to use Airbrake or Errbit for error tracking and reporting. Errbit is an
...
PyGoogle is pre-configured to make it easy to deploy apps into production environments.
...
* setup Errbit or Airbrake and configure PyGoogle to track errors
...
PyGoogle Gemfile does not specify gem versions in order to make upgrading easier.

  bundle update

To merge changes from PyGoogle

  git remote add upstream https://github.com/PyGoogle/Rails4-PyGoogle.git
...
* http://0.0.0.0:3000/p/email?premail=true&layout=email – PyGoogle method with query param configs

Mail previews are only available in development by default. To make PyGoogle previews
...
{Github repo moved to https://github.com/Einsteinish/PyGoogle.git}[https://github.com/Einsteinish/PyGoogle.git]
