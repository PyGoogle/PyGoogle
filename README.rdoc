= Rails 4.1 PyGoogle ({http://demo.pygoogle.com}[http://demo.pygoogle.com])

Bootstrap 3 / Foundation 5 + CoffeeScript + Sass + Devise + everything else you need to get into production, fast.
(Note) This repo was cloned from {Rails 4 Starter-kit}[https://github.com/starterkits/rails4-starterkit] and tested with Apache + Phusion passenger (see the screen shots in Demo section).
...
{Demo}[http://demo.pygoogle.com] — Bootstrap 3
