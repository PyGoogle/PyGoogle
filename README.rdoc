...
{Email Template Preview}[http://pygoogle.com/p/email?premail=true&layout=email] — with inline CSS via Premailer

----
Demo Images 

{Landing Page}[http://pygoogle.com/PyGoogleImages/PyGoogleLandingPage.png]
