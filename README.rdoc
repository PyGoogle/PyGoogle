...
(Note) This repo was cloned from {Rails 4 Starter-kit}[https://github.com/sahat/hackathon-starter.git] and tested with Apache + Phusion passenger (see the screen shots in Demo section).
