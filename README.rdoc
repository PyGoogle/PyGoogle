...
{Demo}[http://pygoogle.com] — Bootstrap 3

{Email Template Preview - not for production}[http://pygoogle.com/p/email?premail=true&layout=email] — with inline CSS via Premailer
...
{SignUp Page}[http://pygoogle.com/PyGoogleImages/PyGoogleSignUpPage.png]

{Facebook Sign Up Page}[http://pygoogle.com/PyGoogleImages/PyGoogleFacebookSignUp.png]

{After signin Facebook}[http://pygoogle.com/PyGoogleImages/PyGoogleSignUpAfterFacebookLogin.png] 

{User Home after signin via Facebook}[http://pygoogle.com/PyGoogleImages/PyGoogleUserHomeAfterSigningUpViaFacebook.png]

{Twitter Sign Up Page}[http://pygoogle.com/PyGoogleImages/PyGoogleTwitterSignUp.png]

{After signin Twitter}[http://pygoogle.com/PyGoogleImages/PyGoogleSignUpAfterTwitterLogin.png]

{Native site Sign Up Page}[http://pygoogle.com/PyGoogleImages/PyGoogleDirectSignUpPage.png]
